...
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/plist-3.2.0/lib"
...
$:.unshift "#{path}/"
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/curb-0.9.1/lib"
$:.unshift "#{path}/../#{ruby_engine}/#{ruby_version}/gems/curb-0.9.1/ext"
